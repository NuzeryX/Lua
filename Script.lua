...
local function createVCREffects(parent)
	...
	-- Create noise effect
	local noiseEffect = Instance.new("Frame")
	...
	for i, itemText in ipairs(menuItems) do
		...
		menuItem.MouseButton1Click:Connect(function()
			if itemText == "PLAY" then
				...
				print("Clicked:", itemText)  -- Debug print for other buttons
			end
		end)
...
local success, err = pcall(function()
	...
	local function calculateNoise()
		...
		if x == 0 then
			noiseImage.Image = "rbxassetid://2297482648"
		elseif x == 1 then
			noiseImage.Image = "rbxassetid://2297483662"
		elseif x == 2 then
			noiseImage.Image = "rbxassetid://2297484608"
		elseif x == 3 then
			noiseImage.Image = "rbxassetid://2297485059"
		elseif x == 4 then
			noiseImage.Image = "rbxassetid://2297485539"
		elseif x == 5 then
			noiseImage.Image = "rbxassetid://2297486750"
		elseif x == 6 then
			noiseImage.Image = "rbxassetid://2297487096"
		elseif x == 7 then
			noiseImage.Image = "rbxassetid://2297487323"
		elseif x == 8 then
			noiseImage.Image = "rbxassetid://2297488547"
		elseif x == 9 then
			noiseImage.Image = "rbxassetid://2297488547"
		elseif x == 10 then
			noiseImage.Image = "rbxassetid://2297488944"
		end
	end
